...
<body>
    <section id="master">
        ...
        <div id="right">
            ...
            <div id="dash-board">
                <h1 class="arrange">Add Task</h1>
                <form action="db_store.php" method="post" id="dash-board">
                <input type="text" placeholder="Task title" class="tsk-inpts" name="tname" required/>
                <input type="text" placeholder="Task description" class="tsk-inpts" name="tdes" required/>
                <!-- <input type="text" placeholder="Task status" class="tsk-inpts" name="tstatus" required/> -->
                <select name="tstatus" class="tsk-inpts" required>
